...
`endif
	...
	rdfifo_altsyncram   altsyncram14
	( 
	.address_a(wraddress),
	.address_b(rdaddress),
	.clock0(inclock),
...
`endif
	...
	assign
		...
		sset = 1'b0,
		sset_node = 1'b0;
endmodule //rdfifo_cntr

//synthesis_resources = lut 102 M4K 2 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  rdfifo_alt_sync_fifo
	( 
	aclr,
	data,
	q,
...
endmodule //rdfifo_alt_sync_fifo
...
module  rdfifo_dcfifo
	...
	rdfifo_alt_sync_fifo   sync_fifo
	( 
	.aclr(aclr),
	.data(data),
	.q(wire_sync_fifo_q),
...
module rdfifo (
	...
	rdfifo_dcfifo	rdfifo_dcfifo_component (
				.data (data),
				.rdclk (rdclk),
				.rdreq (rdreq),
				.wrclk (wrclk),
